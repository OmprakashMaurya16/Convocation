export default function ActiveDevices() {
  const devices = [
    ...
    { id: "DEV-SCN-02", location: "Robe Desk A-1", status: "online" },
    {
      id: "DEV-SCN-05",
      location: "North Hall Seating",
      status: "disconnected",
    },
  ];
      ...
      <div className="space-y-4">
        {devices.map((device) => (
          <div key={device.id} className="flex items-center justify-between">
            ...
            <span
              className={`text-[10px] font-bold uppercase ${device.status === "online" ? "text-emerald-600" : "text-error"}`}
            >
