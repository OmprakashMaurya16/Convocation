      ...
      <div className="flex items-center gap-1.5 xs:gap-2 md:gap-4 w-full md:w-auto justify-end">
        ...
        <div className="flex gap-1 md:gap-2 flex-shrink-0">
          {onLogout ? (
            <button
              onClick={onLogout}
              className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-semibold rounded-md border border-error/20 bg-error-container text-on-error-container hover:bg-error hover:text-white transition-colors"
            >
